...
var act, actions, activeCharacter, activeIndex, displayOverlays, groundswell, map, next, objects, objectsAt, pointAdd, pointClamp, slime, slimeSha, special, tileset, wizard, wizardSha,
  __slice = [].slice;
...
objectsAt = function(i, j, k) {
  var inCell;
  return inCell = objects.select(function(object) {
